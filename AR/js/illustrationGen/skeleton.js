...
// Convert ES6 imports to regular JavaScript
...
if (typeof window !== 'undefined') {
    ...
    window.Bone = Bone;
    window.allPartNames = allPartNames;
    window.facePartName2Index = facePartName2Index;
}


// Make classes and constants available globally
window.Skeleton = Skeleton;
window.Bone = Bone;
window.allPartNames = allPartNames;
window.facePartName2Index = facePartName2Index;
