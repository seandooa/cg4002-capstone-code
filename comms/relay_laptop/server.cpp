...
void esp_receive_server() {
    ...
    while (true) {
        ...
        // std::cout << "Accepted connection from " << client_ip << ", port " << ntohs(cli_addr.sin_port) << "\n";
	    ...
	    biometrics_data = packet;
            ...
            if (packet.start) {
                std::cout << "mode: " << packet.mode << ", hr: " << packet.hr << ", reps: " << packet.reps << ", start: true\n";
            } else {
                std::cout << "mode: " << packet.mode << ", hr: " << packet.hr << ", reps: " << packet.reps << ", start: false\n";
            }
        }
